    ...
    <div class="card-body">        
        <form method="" action="">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="buyer_email" name="buyer_email" required title="email only" />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" pattern="^[A-Za-z]+$" class="form-control" id="city" name="city" required title="text only" />
            </div>

            <div class="form-group">
                <label for="title">Phone</label>
                <input type="number" min="0" class="form-control" id="phone" name="phone" required title="number only" />
            </div>

            <div class="form-group">
                <label for="title">Entry By</label>
                <input type="number" min="0" class="form-control" id="entry_by" name="entry_by" required title="number only" />
            </div>
